    ...
    <BackgroundWrapper>
      ...
      <div className="px-6 py-4 border-b border-[#d4b96e]/30 bg-[#1a0d2c]/80 backdrop-blur-sm">
        <div className="max-w-lg mx-auto">
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-bold text-[#d4b96e]">{t('donationOverview.myDonations')}</h1>
            ...
            >
              {isRefreshing ? (
                ...
                <>
                  ...
                  {t('donationOverview.refreshData')}
                </>
              )}
            </button>
          </div>
      ...
      <div className="max-w-lg mx-auto px-4 py-6">
        ...
        <div className="mt-6 p-5 rounded-xl bg-[#1a0d2c]/90 backdrop-blur-sm">
          <h2 className="text-lg font-bold text-[#d4b96e] mb-4">{t('donationOverview.donationDetails')}</h2>

          <div className="space-y-4">
            <div className="flex justify-between items-center border-b border-islamic-medium/30 pb-3">
              <span className="text-sm text-islamic-cream/80">{t('donationOverview.donationDate')}</span>
              <span className="text-sm font-medium text-islamic-cream">{donationData.startDate}</span>
            </div>

            <div className="flex justify-between items-center border-b border-islamic-medium/30 pb-3">
              <span className="text-sm text-islamic-cream/80">{t('donationOverview.donationAmount')}</span>
              <span className="text-sm font-medium text-islamic-cream">{donationData.totalDonation || 0} U</span>
            </div>

            <div className="flex justify-between items-center border-b border-islamic-medium/30 pb-3">
              <span className="text-sm text-islamic-cream/80">{t('donationOverview.donationPeriod')}</span>
              <span className="text-sm font-medium text-islamic-cream">40 {t('donationOverview.days')}</span>
            </div>

            <div className="flex justify-between items-center border-b border-islamic-medium/30 pb-3">
              <span className="text-sm text-islamic-cream/80">{t('donationOverview.vipLevel')}</span>
              <span className="text-sm font-medium text-islamic-cream">VIP {donationData.vipLevel || 0}</span>
            </div>
            
            <div className="flex justify-between items-center border-b border-islamic-medium/30 pb-3">
              <span className="text-sm text-islamic-cream/80">{t('donationOverview.totalReferrals')}</span>
              <span className="text-sm font-medium text-islamic-cream">{teamInfo?.totalReferrals || 0}</span>
            </div>
            
            <div className="flex justify-between items-center border-b border-islamic-medium/30 pb-3">
              <span className="text-sm text-islamic-cream/80">{t('donationOverview.withdrawableAmount')}</span>
              <span className="text-sm font-medium text-islamic-cream">{user?.rewardAmount || "0"} USDT</span>
            </div>
            
            <div className="flex justify-between items-center border-b border-islamic-medium/30 pb-3">
              <span className="text-sm text-islamic-cream/80">{t('donationOverview.withdrawnAmount')}</span>
              <span className="text-sm font-medium text-islamic-cream">{user?.withdrawAmount || "0"} USDT</span>
            </div>

            <div className="flex justify-between items-center">
              <span className="text-sm text-islamic-cream/80">{t('donationOverview.transactionId')}</span>
