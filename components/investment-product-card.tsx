    ...
    >
      ...
      <div className="relative h-32 w-full">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-islamic-dark/80 to-transparent p-3">
          <div className="flex items-baseline">
            ...
            <span className="text-xs text-islamic-cream/70 ml-1">日化收益率</span>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 flex-1 flex flex-col">
        ...
        <div className="mt-3 grid grid-cols-2 gap-x-2 gap-y-1 text-xs">
          <div className="text-[#f5efe0]/70">投资期限</div>
          <div className="font-medium text-[#f5efe0] text-right">{period}</div>

          <div className="text-[#f5efe0]/70">最低投资</div>
          <div className="font-medium text-[#f5efe0] text-right">{minAmount}</div>
        </div>

        <Button className="mt-4 w-full bg-[#d4b96e] hover:bg-[#d4b96e]/90 text-[#1a0d2c]" onClick={handleInvestClick}>
          立即投资
