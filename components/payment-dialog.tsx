...
export function PaymentDialog({ 
  ...
  const handlePayment = async () => {
    ...
    if (!isNetworkSupported) {
      error("Please switch to a supported network");
      return;
    }
        ...
        {!isProcessing && !isComplete ? (
              ...
              <div className="flex flex-col space-y-3 rounded-md border border-islamic-medium/50 p-4 bg-islamic-medium/30">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <span className="text-islamic-cream">Payment Wallet</span>
                  </div>
                  {!isConnected ? (
                ...
                {isConnected && address && (
                  <div className="space-y-2">
                    ...
                    <div className="text-xs">
                      <p className="text-islamic-cream/70 mb-1">Connected Wallet:</p>
                    ...
                    {chainId !== undefined && (
                      <div className="text-xs">
                        <p className="text-islamic-cream/70 mb-1">Network:</p>
                        <div className="flex items-center">
                        ...
                        {!isNetworkSupported && (
                          <p className="text-red-400 text-xs mt-1">
                            Please switch to a supported network ({SUPPORTED_NETWORK_NAMES})
                          </p>
                        )}
                      </div>
                    )}
          ...
          <div className="py-8 flex flex-col items-center justify-center">
            ...
            <p className="text-islamic-cream">
              {paymentStep === 'donating' ? 'Processing donation, please wait...' : 
               paymentStep === 'transferring' ? 'Waiting for transaction confirmation...' : 
               'Processing, please wait...'}
            </p>
            {paymentStep === 'transferring' && transactionHash && (
              <div className="mt-4 text-center">
                <p className="text-xs text-islamic-cream/70 mb-1">Transaction Hash:</p>
                <a 
