      ...
      <div className="p-4 flex-1 flex flex-col">
        <div className="flex justify-between items-center mb-3">
          ...
          <div className="text-right">
            <p className="text-xs text-[#f5efe0]/70">VIP {currentVip + 1} 费用</p>
            <p className="text-lg font-medium text-islamic-gold">{fullAmount} U</p>
          </div>
        </div>
        ...
        <div className="bg-islamic-medium/50 backdrop-blur-sm rounded-lg p-3 mb-3">
          ...
          <div className="grid grid-cols-2 gap-2 mb-2">
            <div className="flex flex-col p-2 bg-islamic-dark/30 rounded-lg">
              ...
              <span className="text-base font-medium text-[#8dc63f]">{nextVipTotalReturn} U</span>
            </div>
            <div className="flex flex-col p-2 bg-islamic-dark/30 rounded-lg">
              <span className="text-xs text-islamic-cream/70">每日资金</span>
              <span className="text-base font-medium text-[#8dc63f]">{nextVipDailyFunds}</span>
            </div>
          </div>
        ...
        <div className="flex items-start space-x-2 rounded-md border border-islamic-gold/20 p-2 bg-islamic-gold/10 mb-3">
          ...
          <p className="text-xs text-islamic-cream/90">
            升级需支付VIP {currentVip + 1} 的全部费用 {fullAmount} U，而非差价。
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-x-2 gap-y-1 text-xs mb-4">
          ...
          <div className="font-medium text-[#f5efe0] text-right">{fullAmount} U</div>
        </div>
