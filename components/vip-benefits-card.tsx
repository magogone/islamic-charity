      ...
      <CardContent>
        <div className="space-y-4">
          <div className="p-3 rounded-lg bg-islamic-medium/70 backdrop-blur-sm">
            <h4 className="text-sm font-medium text-islamic-gold mb-2">{t('donation.donationAndReturns')}</h4>
            <div className="grid grid-cols-2 gap-2">
              <div className="flex flex-col p-2 bg-islamic-dark/30 rounded-lg">
                <span className="text-xs text-islamic-cream/70">{t('donation.donation')}</span>
                <span className="text-lg font-bold text-islamic-gold">{donationAmount} U</span>
              </div>
              <div className="flex flex-col p-2 bg-islamic-dark/30 rounded-lg">
                <span className="text-xs text-islamic-cream/70">{t('donation.totalReturn')}</span>
              ...
              <div className="flex flex-col p-2 bg-islamic-dark/30 rounded-lg col-span-2">
                <span className="text-xs text-islamic-cream/70">{t('donation.period')}</span>
                <span className="text-base font-medium text-islamic-cream">{period} {t('donation.days')}</span>
              </div>
            </div>
          </div>

          <div className="p-3 rounded-lg bg-islamic-medium/70 backdrop-blur-sm">
            <h4 className="text-sm font-medium text-islamic-gold mb-2">{t('donation.dailyReliefFunds')}</h4>
            <div className="flex items-baseline">
              <span className="text-xl font-bold text-[#8dc63f]">{dailyFundRange}</span>
              <span className="text-xs text-islamic-cream/70 ml-2">{t('donation.adjustedBasedOnReferrals')}</span>
            </div>
          </div>

          <div className="p-3 rounded-lg bg-islamic-medium/70 backdrop-blur-sm">
            <h4 className="text-sm font-medium text-islamic-gold mb-2">{t('donation.referralRewards')}</h4>
            <div className="grid grid-cols-3 gap-2 text-xs">
              <div className="flex flex-col items-center p-2 bg-islamic-dark/30 rounded-lg">
                <span className="text-islamic-cream/70">{t('donation.generation1')}</span>
                <span className="text-[#8dc63f] font-medium mt-1">{rewardRates.level1}%</span>
              </div>
              <div className="flex flex-col items-center p-2 bg-islamic-dark/30 rounded-lg">
                <span className="text-islamic-cream/70">{t('donation.generation2')}</span>
                <span className="text-[#8dc63f] font-medium mt-1">{rewardRates.level2}%</span>
              </div>
              <div className="flex flex-col items-center p-2 bg-islamic-dark/30 rounded-lg">
                <span className="text-islamic-cream/70">{t('donation.generation3to5')}</span>
                <span className="text-[#8dc63f] font-medium mt-1">{rewardRates.level3}%</span>
              </div>
            </div>
            <div className="mt-2 text-xs text-right">
              <span className="text-islamic-cream/70">{t('donation.totalRewardRate')}: </span>
              <span className="text-[#8dc63f] font-medium">{rewardRates.total}%</span>
            </div>
          </div>

          <div className="p-3 rounded-lg bg-islamic-medium/70 backdrop-blur-sm">
            <h4 className="text-sm font-medium text-islamic-gold mb-2">{t('donation.reliefFundRate')}</h4>
            <div className="grid grid-cols-2 gap-2">
              <div className="flex items-center justify-between p-2 bg-islamic-dark/30 rounded-lg">
                <span className="text-xs text-islamic-cream/70">{t('donation.noReferrals')}</span>
                <span className="text-xs text-[#8dc63f] font-medium">{reliefFundRates.noReferral}%</span>
              </div>
              <div className="flex items-center justify-between p-2 bg-islamic-dark/30 rounded-lg">
                <span className="text-xs text-islamic-cream/70">{t('donation.oneReferral')}</span>
                <span className="text-xs text-[#8dc63f] font-medium">{reliefFundRates.referral1}%</span>
              </div>
              <div className="flex items-center justify-between p-2 bg-islamic-dark/30 rounded-lg">
                <span className="text-xs text-islamic-cream/70">{t('donation.threeReferrals')}</span>
                <span className="text-xs text-[#8dc63f] font-medium">{reliefFundRates.referral3}%</span>
              </div>
              <div className="flex items-center justify-between p-2 bg-islamic-dark/30 rounded-lg">
                <span className="text-xs text-islamic-cream/70">{t('donation.fiveReferrals')}</span>
