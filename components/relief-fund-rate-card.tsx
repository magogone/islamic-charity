...
export function ReliefFundRateCard({ currentReferrals, className }: ReliefFundRateCardProps) {
  ...
  return (
    <Card className={cn("border-none shadow-md bg-islamic-cardBg/90 backdrop-blur-sm text-white", className)}>
      <CardHeader className="pb-2">
        <CardTitle className="text-lg text-islamic-gold">Relief Fund Rate</CardTitle>
      </CardHeader>
      <CardContent>
